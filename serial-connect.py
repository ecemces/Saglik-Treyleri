...
def validateLogin(username, password):
    ...
    def connect(username): #fonksyionlar düzenlenebilir
            ...
            #time.sleep(0)
            pump.write(b'led = Pin(25, Pin.OUT)\r\n')
            pump.write(b'cekmece1 = Pin(14, Pin.OUT)\r\n')
            #time.sleep(0)
            pump.write(b'led.value(1)\r\n')
            pump.write(b'cekmece1.value(1)\r\n')
            time.sleep(1)
            pump.write(b'led.value(0)\r\n')
    ...
    def connect2(username):
            ...
            pump.write(b'from machine import Pin\r\n')
            #time.sleep(0)
            pump.write(b'led = Pin(9, Pin.OUT)\r\n')
            pump.write(b'cekmece2 = Pin(15, Pin.OUT)\r\n')
            #time.sleep(0)
            pump.write(b'led.value(1)\r\n')
    ...
    def connect3(username):
            ...
            #time.sleep(0)
            pump.write(b'led = Pin(9, Pin.OUT)\r\n')
            pump.write(b'cekmece3 = Pin(16, Pin.OUT)\r\n')
            #time.sleep(0)
            pump.write(b'led.value(1)\r\n')
    ...
    def connect4(username):
            ...
            #time.sleep(0)
            pump.write(b'led = Pin(9, Pin.OUT)\r\n')
            pump.write(b'cekmece4 = Pin(17, Pin.OUT)\r\n')
            #time.sleep(0)
            pump.write(b'led.value(1)\r\n')
    ...
    def connect5(username):
            ...
            #time.sleep(0)
            pump.write(b'led = Pin(9, Pin.OUT)\r\n')
            pump.write(b'cekmece5 = Pin(19, Pin.OUT)\r\n')
            #time.sleep(0)
            pump.write(b'led.value(1)\r\n')
